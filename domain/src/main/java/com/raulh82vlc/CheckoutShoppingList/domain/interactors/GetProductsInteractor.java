...
public interface GetProductsInteractor {
    ...
    void execute(GetProductsListCallback callback) throws ConnectionException, HttpException;

    interface GetProductsListCallback {
        void onGetProductsListOK(List<ProductResponse> comicList);

        void onGetProductsListKO(String error);
    }
}
